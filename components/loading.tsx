...
export default function Loading({size = 24}: LoadingProps) {
  return (
    <svg className={"animate-spin"} width={size} viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
      ...
      <g id="🔍-System-Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="ic_fluent_spinner_ios_20_regular" fill="#212121" fillRule="nonzero">
          <path
